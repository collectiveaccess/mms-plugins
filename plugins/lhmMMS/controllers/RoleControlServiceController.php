<?php
/* ----------------------------------------------------------------------
 * app/plugins/lhmMMS/controllers/RoleControlServiceController.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 * ----------------------------------------------------------------------
 */
require_once(__CA_APP_DIR__.'/plugins/lhmMMS/services/RoleControlService.php');
require_once(__CA_APP_DIR__.'/service/controllers/FindController.php');

class RoleControlServiceController extends BaseServiceController {
	# -------------------------------------------------------
	public function __call($ps_name, $pa_args){
		$vo_service = new RoleControlService($this->request);
		$va_content = $vo_service->push();
