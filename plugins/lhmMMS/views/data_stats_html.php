...
<div class="sectionBox">
	...
	print caFormControlBox(
		'',
		'',
		'Zeitraum: '.str_replace("<input ", "<input id='lhm_data_stats_time' ", caHTMLTextInput('data_stats_search', array('size' => 15, 'value' => $this->getVar('data_stats_search') ?: 'heute')))." ".str_replace("<a ", "<a id='lhm_data_stats_search' ", caFormSubmitButton($this->request, __CA_NAV_ICON_SEARCH__, "", 'mmsDataStatsSearch'))
	);
	print "</form>";
	?>
